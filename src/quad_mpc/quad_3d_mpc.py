...
from src.model_fit.gp_common import restore_gp_regressors
...
# pre_trained_models is the trained NN , lets see how works
class Quad3DMPC:
    def __init__(self, my_quad, t_horizon=1.0, n_nodes=5, q_cost=None, r_cost=None,
        ...
        if isinstance(pre_trained_models, torch.nn.Module):
            ...
            for y_dim in pred_dims:
                ...
                self.mlp = pre_trained_models # pre_trained_models is sent self.mlp which globally be quad_mpc.mlp
